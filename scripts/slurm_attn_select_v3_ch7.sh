#!/bin/bash
#SBATCH --job-name=rnn_attn_sel_v3
#SBATCH --output=logs/rnn_ch7_attn_select_v3_%j.out
#SBATCH --error=logs/rnn_ch7_attn_select_v3_%j.err
...
OUT_DIR=$REPO/out/rnn_ch7_attn_select_v3_${TIMESTAMP}
