#!/bin/bash
#SBATCH --job-name=rnn_attn_sel_v2
#SBATCH --output=logs/rnn_ch7_attn_select_v2_%j.out
#SBATCH --error=logs/rnn_ch7_attn_select_v2_%j.err
...
OUT_DIR=$REPO/out/rnn_ch7_attn_select_v2_${TIMESTAMP}
